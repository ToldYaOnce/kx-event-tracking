...
# Build and Publish Script for kx-event-consumers
# Builds, bumps version, and publishes the event consumers package

set -e  # Exit on any error

echo "🎯 Building and publishing kx-event-consumers..."
...
PACKAGE_DIR="packages/kx-event-consumers"
PACKAGE_NAME="@toldyaonce/kx-event-consumers"
...
# Build the package
print_status "Building kx-event-consumers..."
cd "$PACKAGE_DIR"
pnpm run build
cd - > /dev/null
...
# Summary
echo
print_success "🎉 kx-event-consumers build and publish completed!"
echo "  📦 Version: $new_version"
echo "  🔍 EventBridge discovery utilities ready"
