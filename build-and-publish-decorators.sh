...
# Build and Publish Script for kx-events-decorators
# Builds, bumps version, and publishes the decorators package

set -e  # Exit on any error

echo "🎯 Building and publishing kx-events-decorators..."
...
PACKAGE_DIR="packages/kx-events-decorators"
PACKAGE_NAME="@toldyaonce/kx-events-decorators"
...
# Build the package
print_status "Building kx-events-decorators..."
cd "$PACKAGE_DIR"
pnpm run build
cd - > /dev/null
...
# Summary
echo
print_success "🎉 kx-events-decorators build and publish completed!"
